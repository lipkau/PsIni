...
Function Update-IniContent {
    ...
    .Example
        $ini = Update-IniContent -FilePath "C:\myinifile.ini" -Sections 'Printers' -NameValuePairs 'Name With Space=Value1,AnotherName=Value2'
        -----------
        Description
    ...
    .Example
        Update-IniContent -FilePath "C:\myinifile.ini" -Sections 'Terminals,Monitors' -NameValuePairs 'Updated=FY17Q2' | Out-IniFile "C:\myinifile.ini" -Force
        -----------
        Description
    ...
    .Example
        Get-IniContent "C:\myinifile.ini" | Update-IniContent -NameValuePairs 'Headers=True,Update=False' | Out-IniFile "C:\myinifile.ini" -Force
        -----------
        Description
        Reads in the INI File c:\myinifile.ini using Get-IniContent, which is then piped to Update-IniContent to add or update the 'Headers'  and 'Update' keys in all sections
    ...
    .Example
        Get-IniContent "C:\myinifile.ini" | Update-IniContent -NameValuePairs 'Updated=FY17Q2' -Sections '_' | Out-IniFile "C:\myinifile.ini" -Force
        -----------
        Description
        Reads in the INI File c:\myinifile.ini using Get-IniContent, which is then piped to Update-IniContent to add or update the 'Updated' key that
...
Set-Alias update-ini Update-IniContent
